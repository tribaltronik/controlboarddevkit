...
exports.Start = function(clientMQTT,mainDeviceId)
{
  ...
  // Function for checking memory
    ...
    if (error !== null) {
      ...
      memTotal = stdout;
      clientMQTT.publish(mainDeviceId +'/memoryTotal', memTotal.toString(), {retain: true});
    ...
    if (error !== null) {
      ...
      clientMQTT.publish(mainDeviceId +'/uptime', stdout, {retain: true});
    }
  });
    ...
    if (error !== null) {
      ...
      clientMQTT.publish(mainDeviceId +'/kernel', stdout, {retain: true});
    }
  });
  ...
  setInterval(function(){
    ...
    if (error !== null) {
      ...
      clientMQTT.publish(mainDeviceId +'/temperatureUpdate', temp.toString(), {retain: true});
    }
  });}, 5000);
  ...
  setInterval(function(){
    ...
    if (error !== null) {
      ...
      clientMQTT.publish(mainDeviceId +'/cpuUsageUpdate', parseFloat(stdout).toString(), {retain: true});
    }
  });}, 10000);
}
